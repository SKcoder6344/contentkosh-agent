...
Stack: LangGraph + LangChain + Groq (llama-3.3-70b-versatile)
"""
...
def get_llm(temperature: float = 0.4, max_tokens: int = MAX_TOKENS_DEFAULT) -> ChatGroq:
    """
    Returns a configured ChatGroq instance (free tier, no credit card needed).
